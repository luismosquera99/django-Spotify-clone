...
def top_artists():
    ...
    headers = {
        "X-RapidAPI-Key": "e1ad87f9a3mshce667b63ce1742fp113d8djsn29910d92bba2",
    ...
    if "artists" in response_data:
        for artist in response_data["artists"]:
            ...
            avatar_url = (
                artist.get("visuals", {}).get("avatar", [{}])[0].get("url", "No URL")
            )
...
def top_tracks():
    ...
    if "tracks" in data:
        ...
        for track in shortened_data:
            ...
            cover_url = (
                track["album"]["cover"][0]["url"] if track["album"]["cover"] else None
            )
...
def get_audio_details(query):
    ...
    if response.status_code == 200:
        ...
        if "youtubeVideo" in response_data and "audio" in response_data["youtubeVideo"]:
            ...
            print("No youtube video data available")
    else:
...
def get_track_image(track_id, track_name):
    ...
    # regular expression to get the best quality image
        ...
        if response.status_code == 200:
            ...
            for track in tracks:
                ...
                if get_track_image(trackid, track_name):
                    ...
                    track_image = "https://luismosquerab.com/wp-content/uploads/2024/02/Logo-e1708474233662.png.com"
    ...
    if response.status_code == 200:
        ...
        for track in data["discography"]["topTracks"]:
            ...
            if get_track_image(trackid, trackname):
                ...
                trackimage = "https://luismosquerab.com/wp-content/uploads/2024/02/Logo-e1708474233662.png"
